...
3. Tap `Add a Message` and include: Your name (same as the one used during hackathon registration), along with your Curvy ID where your staked funds will be returned
