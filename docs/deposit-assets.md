...
When someone enters your Curvy ID in the recipient field, Curvy automatically generates a new receiving address in the background.
...
## Option 2: Manually Generate a Receiving (Stealth) Address

- Tap `Receive` in the Curvy app

![Receive1](./public/images/receive1.png)
  
- A new receiving (stealth) address will be generated automatically.
...
Make sure to select the correct network before sharing your address. Addresses on different networks may differ in format. 
